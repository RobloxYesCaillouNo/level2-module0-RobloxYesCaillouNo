...
public class _02_FindTheHiddenButton implements ActionListener{
	...
	public void start() {
		...
		String size = JOptionPane.showInputDialog("plz insert a PoSiTiVe number.");
		...
		JOptionPane.showMessageDialog(null, "Find the hidden button. Thats all. im not gonna help u. theres no turnin back now");
	...
	public void actionPerformed(ActionEvent e) {
		...
		//18. else tell them to try again
			...
			JOptionPane.showMessageDialog(null, "Pleas try again!");
		}
	}
}
